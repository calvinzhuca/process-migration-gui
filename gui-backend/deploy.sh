...
cp /home/czhu/works/git/bpms7_git/calvin_fork/process-migration-gui/gui-backend/target/backend.war /home/czhu/jboss/BPMS/rhpam-7.0.0.GA/rhpam-businessCentral_71/standalone/deployments/
